            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">电影详情</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/homepage">主页</a></li>
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/movie">电影管理</a></li>
                            <li class="breadcrumb-item active">电影详情</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                 <form class="form-horizontal form-material" method="post" action="addCinemaRequest">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="${movie.movie_name }" readonly  unselectable="on" class="form-control form-control-line" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">电影类型</label>
                                        <div class="col-md-12">
                                        <c:forEach items = "${types }" var = "type">
                                        <c:if test="${type.type_id == movie.type_id }"><input type="text" value="${type.type_name }" readonly  unselectable="on" class="form-control form-control-line" >
                                        </c:if>
                                    ...
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">电影介绍</label>
                                        <div class="col-md-12">
                                        <textarea rows="5" class="form-control form-control-line" name="movie_introduce" readonly  unselectable="on" >${movie.movie_introduce }</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">电影语言</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${movie.movie_language }" readonly  unselectable="on" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">上映日期</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${movie.movie_date }" readonly  unselectable="on" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">关键词</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${movie.key_word }" readonly  unselectable="on" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">封面图</label>
                                        <div class="col-md-12">
                                            <c:if test = "${movie.img_url eq '' }"><img src="http://localhost:8080/src/img/fm.png" style="height:10%;width:10%;"/></c:if>
                                            <c:if test = "${movie.img_url ne '' }"><img src="http://localhost:8080/src/${movie.img_url }" style="height:10%;width:10%;"/></c:if>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <a class="btn btn-success" href="${pageContext.request.contextPath}/updateMovie?Id=${movie.movie_id }">修改电影信息</a>
                        					<a href="${pageContext.request.contextPath}/deleteMovie?Id=${movie.movie_id }" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"   onclick="return adminDelete()"> 删除影院信息</a>
                                        </div>
                                    </div>
                             	</form>
                            </div>
