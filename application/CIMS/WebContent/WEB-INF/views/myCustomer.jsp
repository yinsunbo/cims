			...
			<div class="security_content" style="width: 750px;">
				<div class="security-left">
					...
					<ul id="ser-ul" class="security-ul">
						<li class="security-list router-link-exact-active on" onclick="location.href='${pageContext.request.contextPath}/home/customer';">
						<span class="security-nav-name">我的信息</span></li>

						<li class="security-list" onclick="location.href='${pageContext.request.contextPath}/home/myComment';">
				...
				<div class="security-right" style="width: 598px;">
					...
					<div class="user-setting-warp">
						<div>
							<form class="clearfix"
								action="${pageContext.request.contextPath}/home/updateCustomer"
								method="post">
								...
								<div class="el-form-item user-nick-name">
									...
									<div class="el-input">${customer.customer_phone }</div>
								</div>
								<div class="el-form-item user-nick-name">
								...
								<div class="el-form-item user-my-btn">
									<div class="el-form-item__content">
										...
										<div class="user-my-btn-warp">
											<button type="sumbit" class="el-button el-button--primary">
												<span>保存</span>
											</button>
										</div>
									</div>
