            ...
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/homepage">
                         ...
                         <img src="${pageContext.request.contextPath}/img/logo.png" class="light-logo" alt="${pageContext.request.contextPath}/homepage" /></span> </a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">添加影院</h1>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">添加影院</li>
                        </ol>
                    </div>
                	 ...
                	 <div class="col-md-12 col-4 align-self-center">
                        <div class="card">
                            <div class="card-block">
                                 <form class="form-horizontal form-material" method="post" action="addCinemaRequest" id="form">
                                    <div class="form-group">
                                        <label class="col-md-12">影院名称</label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line"  name="cinema_name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                        	<center>
                                            <button class="btn btn-success col-sm-3" type="submit">添加影院</button>
                                            </center>
                                        </div>
                                    </div>
                             	</form>
