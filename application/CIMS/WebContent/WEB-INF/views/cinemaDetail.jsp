            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">影院详情</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/homepage">主页</a></li>
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/cinema">影院管理</a></li>
                            <li class="breadcrumb-item active">影院详情</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                 <form class="form-horizontal form-material" method="post" action="addCinemaRequest">
                                    <div class="form-group">
                                        <label class="col-md-12">影院名称</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${cinema.cinema_name }" readonly  unselectable="on" class="form-control form-control-line"  name="cinema_name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">位置</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${cinema.location }" readonly  unselectable="on" class="form-control form-control-line"  name="location">
                                            
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">联系电话</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${cinema.tel }" readonly  unselectable="on" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <a class="btn btn-success" href="${pageContext.request.contextPath}/updateCinema?Id=${cinema.cinema_id }">修改影院信息</a>
                        					<a href="${pageContext.request.contextPath}/deleteCinema?Id=${cinema.cinema_id }" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"    onclick="return adminDelete()"> 删除影院信息</a>
                                        </div>
                                    </div>
                             	</form>
                            </div>
