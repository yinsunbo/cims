            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">用户管理</h1>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="user/addUser" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> 添加员工用户</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${Users}" var="user">
                                            <tr>
                                                <td  onclick="location.href='user/${user.noId }';">${user.noId }</td>
                                                <td onclick="location.href='user/${user.noId }';">${user.userName }</td>
                                                <td onclick="location.href='user/${user.noId }';">${user.cinema_name }</td>
                                                <td><center></center>
                                    <a class="btn btn-success " href="updateUser?Id=${user.noId }">修改</a>
                                    <a href="deleteUser?Id=${user.noId }" class="btn btn-danger " onclick="return adminDelete()"> 删除</a>
                   	 				</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                         ...
                         <nav aria-label="Page navigation pagination-lg">
                                    ...
                                    <c:forEach begin="1" end="${countUser }" var="c">
                                    <a href="${pageContext.request.contextPath}/userPage?pageId=${c }" class="btn">${c }</a>
                                    </c:forEach>
                                    <li class="btn">
                                    </a>
                                    </li>
