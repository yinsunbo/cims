...
<div class="row">
  ...
  <div class="column2">
    <div style="background:#FFFBC5;">
    <center><h1>支付成功</h1></center>
     <a href="${pageContext.request.contextPath}/home/order" class="btn btn-primary" style="float:left ">查看我的订单</a>
      <a class="btn btn-default" href="${pageContext.request.contextPath}/home" style="float:right ">返回首页</a>
     </div>
     </div>
