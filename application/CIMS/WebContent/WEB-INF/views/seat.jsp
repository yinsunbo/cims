            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">座位管理</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/homepage">主页</a></li>
                            <li class="breadcrumb-item active">座位管理</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="${pageContext.request.contextPath}/seat/addSeat" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> 添加座位</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <c:forEach items="${seats}" var="seat">
                                            <tr >
                                            	<td onclick="location.href='${pageContext.request.contextPath}/seat/${seat.seat_id }';">${seat.seat_id }</td>
                                                <td onclick="location.href='${pageContext.request.contextPath}/seat/${seat.seat_id }';">${seat.seat_name  }</td>
                                                <td><center></center>
                       	             <a class="btn btn-success " href="updateSeat?Id=${seat.seat_id  }">修改</a>
                                    <a href="deleteSeat?Id=${seat.seat_id  }" class="btn btn-danger " onclick="return adminDelete()"> 删除</a>
                   	 				</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                         ...
                         <nav aria-label="Page navigation pagination-lg">
                                    ...
                                    <c:forEach begin="1" end="${countSeat }" var="c">
                                    <a href="${pageContext.request.contextPath}/seat/seatPage?pageId=${c }" class="btn">${c }</a>
                                    </c:forEach>
                                    <li class="btn">
                                    </a>
                                    </li>
