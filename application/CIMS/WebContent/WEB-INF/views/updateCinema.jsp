            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">修改影院信息</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/homepage">主页</a></li>
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/cinemaList">影院管理</a></li>
                            <li class="breadcrumb-item active">修改影院信息</li>
                        </ol>
                    </div>
                	 ...
                	 <div class="col-md-12 col-4 align-self-center">
                        <div class="card">
                            <div class="card-block">
                                 <form class="form-horizontal form-material" method="post" action="updateCinemaRequest?Id=${cinema.cinema_id}" id="form">
                                    <div class="form-group">
                                        <label class="col-md-12">影院名称</label>
                                        <div class="col-md-12">
                                            <input type="text"  class="form-control form-control-line"  name="cinema_name" value="${cinema.cinema_name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">位置</label>
                                        <div class="col-md-12">
                                            <input type="text" value="${cinema.location}" class="form-control form-control-line"  name="location">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="${cinema.tel}" class="form-control form-control-line" name="tel" >
                                        </div>
                                    </div>
