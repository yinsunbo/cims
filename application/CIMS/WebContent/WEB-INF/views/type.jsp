...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">分类管理</h1>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-md-7 col-4 align-self-center">
                        <a  class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down" href="#" onclick="addTypeBtn()"> 添加类型</a>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <table class="table">
                                        ...
                                        <c:forEach items="${types}" var="t">
                                            <tr id="${t.type_id }">
                                                ...
                                                <td>${t.type_name  }</td>
                                                <td>
                       	             <a class="btn btn-success " href="javascript:void(0)" onclick="updateType(${t.type_id },'${t.type_name  }')">修改</a>
                                    <a class="btn btn-danger "  href="javascript:void(0)" onclick="return adminDelete(${t.type_id })"> 删除</a>
                   	 				</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
    ...
    <script src="${pageContext.request.contextPath}/js/typeJs.js">
        </script>
</body>
