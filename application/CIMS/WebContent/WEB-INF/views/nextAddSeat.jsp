...
<body class="fix-header fix-sidebar card-no-border">
				...
				<div class="row">
					<div class="col-md-12 col-4 align-self-center">
							...
							<div class="card-block">
								...
								<form class="form-horizontal form-material" method="post"
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="number" class="form-control form-control-line"
												id="seat_column" name="seat_column" value="${seat_column }" placeholder="取值范围1-48" min="0" max="48">
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
											<center>
												<button class="btn btn-success col-sm-3" type="submit">生成座位</button>
											</center>
										</div>
									</div>
								</form>
						...
						<div class="card" id="generateDiv">
							<form class="form-horizontal form-material" method="post"
								action="addSeatRequest" id="form2">
								<div class="form-group">
									<div class="card-block">
										<div class="form-group">
											<div class="col-md-12">
									...
									<label class="col-md-12">影厅名称</label>
									<div class="col-md-12">
										<input type="text" class="form-control form-control-line"
											name="seat_name"> <input type="text" id="input_map"
											class="form-control form-control-line" name="seat_map"
											style="display: none;"> <input type="text"
											value="${seat_row }" class="form-control form-control-line"
											name="seat_row" style="display: none;"> <input type="text"
											value="${seat_column }" class="form-control form-control-line"
								...
								<div class="form-group">
									<div class="col-sm-12">
										<center>
											<button class="btn btn-success col-sm-3" type="submit">添加座位</button>
										</center>
									</div>
								</div>
							</form>
	...
	<script>$(document).ready(function(){
		firstSeatLabel = 1;
    	var row=${seat_row};//获取座位行数
    	var column=${seat_column};//获取座位列数
