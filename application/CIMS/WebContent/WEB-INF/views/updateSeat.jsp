				...
				<div class="row">
					<div class="col-md-12 col-4 align-self-center">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="number" class="form-control form-control-line"
												id="seat_row" name="seat_row" value="${seat.seat_row }">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="number" class="form-control form-control-line"
												id="seat_column" name="seat_column" value="${seat.seat_column }">
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12">
						...
						<div class="card" id="generateDiv">
							<form class="form-horizontal form-material" method="post"
								action="updateSeatName?Id=${seat.seat_id }" id="form2">
								<div class="form-group">
									<div class="card-block">
										<div class="form-group">
											<div class="col-md-12">
									...
									<div class="col-md-12">
										<input type="text" class="form-control form-control-line"
											name="seat_name" value="${seat.seat_name }"> 
									</div>
								</div>
								...
								<div class="form-group">
									<div class="col-sm-12">
										<center>
											<button class="btn btn-success col-sm-3" type="submit">修改影厅名称</button>
										</center>
									</div>
								</div>
							</form>
