...
<body class="fix-header fix-sidebar card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <center>
                        <h1 class="text-themecolor m-b-0 m-t-0" >删除成功</h1>
                    </center> 
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                         ...
                         <br>
                         <center>
                         <h2 class="text-themecolor m-b-0 m-t-0">删除数据成功，稍后自动返回管理页！</h2>
	...
	str="删除影院数据成功,稍后自动跳转影院管理页。";
	alert(str);
	setTimeout(window.location.href='cinema',3000);
}
)
