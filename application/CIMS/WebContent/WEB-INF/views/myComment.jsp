...
<body>
	...
	<div class="row">
		...
		<div class="column2">
			<div class="security_content" style="width: 750px;">
				<div class="security-left">
					<span class="security-title">个人中心</span>
					<ul id="ser-ul" class="security-ul">
						<li class="security-list router-link-exact-active" onclick="location.href='${pageContext.request.contextPath}/home/customer';">
						<span class="security-nav-name">我的信息</span></li>

						<li class="security-list on" onclick="location.href='${pageContext.request.contextPath}/home/myComment';">
							<span class="security-nav-name" >我的评论</span></li>
					</ul>
				</div>
				<div class="security-right" style="width: 598px;">
					<div class="security-right-title">
						<span class="security-right-title-icon"></span> <span
							class="security-right-title-text">我的评论</span>
					</div>
					<div class="user-setting-warp">
						<div>
                            ...
                            <div class="list-item" onclick="location.href='${pageContext.request.contextPath}/home/comment?movie_id=${comment.movie_id}';">
                            ...
                            <div class="content">
                                ...
                                <p class="sty" style="font-size: 16px;">内容：${comment.comment_content }</p>
                                <div class="info">
                                    <span class="time">${comment.comment_time  }</span>
                                </div>
                                <div class="sty"><a href="${pageContext.request.contextPath}/home/delComment?comment_id=${comment.comment_id}">删除评论</a> </div>
                            </div>
                            </div>
                            </c:forEach>
                        </div>
