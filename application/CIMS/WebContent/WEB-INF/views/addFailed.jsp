...
<body class="fix-header fix-sidebar card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <center>
                        <h1 class="text-themecolor m-b-0 m-t-0" >添加失败</h1>
                    </center> 
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                         ...
                         <br>
                         <center>
                         <h2 class="text-themecolor m-b-0 m-t-0">添加${entityName}数据失败,稍后自动跳转${entityName}管理页。</h2>
	...
	str="添加${entityName}数据失败,稍后自动跳转${entityName}管理页。";
	alert(str);
	setTimeout(function(){
