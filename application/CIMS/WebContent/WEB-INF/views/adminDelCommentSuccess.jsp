...
$(document).ready(function(){
	setTimeout(function(){
        self.location.href="${pageContext.request.contextPath}/home/comment?movie_id=${movie_id}"
    },1000);
})
</script>
</head>
			...
			<div class="security_content" style="width: 900px;height:300px;margin-top:230px">
				<div class="security-right" style="width: 900px;height:300px">
					...
					<div class="user-setting-warp" style="margin-top:60px">
					   <div>
                            <p class="comment-title">删除评论成功，稍后返回<a href="${pageContext.request.contextPath}/home/comment?movie_id=${movie_id}">电影评论</a>页面</p>
					   </div>
					</div>
				</div>
			</div>
