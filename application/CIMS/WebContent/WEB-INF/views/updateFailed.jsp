...
<body class="fix-header fix-sidebar card-no-border">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <center>
                        <h1 class="text-themecolor m-b-0 m-t-0" >更新失败</h1>
                    </center> 
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                         ...
                         <br>
                         <center>
                         <h2 class="text-themecolor m-b-0 m-t-0">更新${entityName}数据失败,稍后自动跳转${entityName}详情页。</h2>
	...
	str="更新${entityName}数据失败,稍后自动跳转${entityName}详情页。";
	alert(str);
	setTimeout(function(){
		self.location.href="${entity}/${Id}"
	},3000);
}
)	
</Script>
