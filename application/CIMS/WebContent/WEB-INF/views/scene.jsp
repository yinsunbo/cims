            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">场次管理</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="homepage">主页</a></li>
                            <li class="breadcrumb-item active">场次管理</li>
                        </ol>
                    </div>
                    <div class="col-md-7 col-4 align-self-center">
                        <a href="scene/addScene" class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down"> 添加场次</a>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>场次编号(Id)</th>
                                                <th>场次名称(Scene Name)</th>
                                                <th>场次日期(Scene Date)</th>
                                                <th>操作</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        ...
                                        <c:forEach items="${Scenes}" var="scene">
                                            <tr>
                                            	<td  onclick="location.href='scene/${scene.scene_id }';">${scene.scene_id }</td>
                                                <td  onclick="location.href='scene/${scene.scene_id }';">${scene.scene_name }</td>
                                                <td  onclick="location.href='scene/${scene.scene_id }';">${scene.scene_date } ${scene.start_time }</td>
                                                <td>
                                               
                       	             <a class="btn btn-success " href="updateScene?Id=${scene.scene_id }">修改</a>
                                    <a href="deleteScene?Id=${scene.scene_id }" class="btn btn-danger " onclick="return adminDelete()"> 删除</a>
                   	 				</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                         ...
                         <nav aria-label="Page navigation pagination-lg">
                                    ...
                                    <c:forEach begin="1" end="${countScene }" var="c">
                                    <a href="${pageContext.request.contextPath}/scenePage?pageId=${c }" class="btn">${c }</a>
                                    </c:forEach>
                                    <li class="btn">
                                    </a>
                                    </li>
