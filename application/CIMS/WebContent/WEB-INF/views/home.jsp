            ...
            <nav class="navbar top-navbar navbar-toggleable-sm navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">
                         ...
                         <img src="img/logo.png" class="light-logo" alt="#" /></span> </a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h1 class="text-themecolor m-b-0 m-t-0">主页</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                         ...
                         <br>
                         <center>
                         <h2 class="text-themecolor m-b-0 m-t-0">尊敬的用户：${sessionScope.user.userName}</h2>
                         <h2 class="text-themecolor m-b-0 m-t-0">欢迎登录影院管理系统</h2>
                         <br>
                         </center>
                         <br>
                         <br>
                         ...
                         <br>
                         <br>
                         <a class="btn " href="/CIMS/home" >查看前台</a> 
                         <br>
                         <br>
                         <br>
                         <br>
